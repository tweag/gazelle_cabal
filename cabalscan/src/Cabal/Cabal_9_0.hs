...
import Distribution.Simple.BuildPaths as Cabal (autogenPathsModuleName)
import Distribution.Types.GenericPackageDescription as Cabal (GenericPackageDescription, condLibrary, condExecutables, condTestSuites, condBenchmarks, packageDescription, condSubLibraries)
